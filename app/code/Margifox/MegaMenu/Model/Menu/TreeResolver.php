...
namespace Margifox\MegaMenu\Model\Menu;
...
class TreeResolver extends \Amasty\MegaMenu\Model\Menu\TreeResolver
{
    ...
    public function __construct(
        ...
        parent::__construct($nodeFactory, $treeFactory, $categoryCollectionFactory, $itemCollectionFactory, 
            $categoryHelper, $storeManager, $dataObjectFactory, $resourceResolver, 
            $positionCollectionFactory, $urlBuilder, $layerResolver);
    ...
    private function getItemAsArray($storeId, $item)
    {
        ...
        return [
            ...
            'is_category' => false,
            'is_parent_active' => true,
            'add_menu_login' => $item->getCustomerLogin(),
