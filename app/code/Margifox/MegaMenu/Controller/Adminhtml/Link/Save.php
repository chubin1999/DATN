<?php
namespace Margifox\MegaMenu\Controller\Adminhtml\Link;
...
class Save extends \Amasty\MegaMenu\Controller\Adminhtml\Link\Save
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($context, $linkRepository, $itemRepository, $linkFactory, $itemFactory, $dataPersistor, $dataObject, $logger);
    ...
    private function retrieveItemContent(&$data)
    {
        ...
        $array_gereral['general'] = ItemInterface::FIELDS_BY_STORE_CUSTOM['general'];
        array_push($array_gereral['general'],'customer_login');

        $array_custom_data = ItemInterface::FIELDS_BY_STORE_CUSTOM;
        $array_custom_data = array_merge($array_custom_data, $array_gereral);

        foreach ($array_custom_data as $fieldSet) {
