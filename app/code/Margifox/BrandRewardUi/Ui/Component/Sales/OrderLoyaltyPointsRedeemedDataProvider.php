...
class OrderLoyaltyPointsRedeemedDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function getCollection()
    {
        ...
        $collection->addFieldToFilter('entity_name', StatusHistoryEntityType::LOYALTY_REDEEMING)
