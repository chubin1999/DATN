...
namespace Margifox\BrandRewardUi\Ui\Component\Loyalty\History;
...
class EarningDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    /**
    ...
    public function getCollection()
    {
        ...
        $collection = $collection->addFieldToFilter('entity_name', StatusHistoryEntityType::LOYALTY_EARNING);
        if (!$companyId) {
            return $collection;
        }
    ...
    public function getData()
    {
        ...
        foreach ($data['items'] as &$historyItem) {
            ...
            $pointsEarned = $this->rate->calculateToCurrency($historyRecord['points_earned']);
            $historyItem['points_earned_dollar'] = $pointsEarned;
