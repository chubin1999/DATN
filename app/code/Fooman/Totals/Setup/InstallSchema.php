...
class InstallSchema implements InstallSchemaInterface
{
    ...
    private function createFoomanTotalsOrder(SchemaSetupInterface $setup)
    {
        $table = $setup->getConnection()->newTable($setup->getTable('fooman_totals_order'))
            ...
            ->addIndex(
                $setup->getIdxName('fooman_totals_order', ['order_id']),
                ['order_id']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_order', ['type_id']),
                ['type_id']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_order', ['code']),
                ['code']
            )
    ...
    private function createFoomanTotalsInvoice(SchemaSetupInterface $setup)
    {
        $table = $setup->getConnection()->newTable($setup->getTable('fooman_totals_invoice'))
            ...
            ->addIndex(
                $setup->getIdxName('fooman_totals_invoice', ['order_id']),
                ['order_id']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_invoice', ['invoice_id']),
                ['invoice_id']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_invoice', ['code']),
                ['code']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_invoice', ['type_id']),
                ['type_id']
            )
    ...
    private function createFoomanTotalsCreditmemo(SchemaSetupInterface $setup)
    {
        $table = $setup->getConnection()->newTable($setup->getTable('fooman_totals_creditmemo'))
            ...
            ->addIndex(
                $setup->getIdxName('fooman_totals_creditmemo', ['order_id']),
                ['order_id']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_creditmemo', ['creditmemo_id']),
                ['creditmemo_id']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_creditmemo', ['code']),
                ['code']
            )
            ->addIndex(
                $setup->getIdxName('fooman_totals_creditmemo', ['type_id']),
                ['type_id']
            )
